...
!!! note "¿Qué es _Databús_?"
_Databús_ es el subsistema de recolección, creación y distribución de **datos** del servicio de transporte público, tanto la información "estática" de rutas, horarios, mapas y otros, como alertas y la información en tiempo real de los vehículos.
...
_Databús_ tiene varios componentes, cuya relación está indicada en el siguiente esquema.
