...
**Contras:**
-  No tracking de qué está instalado
-  No workflow de aprobación

**Cuándo es suficiente:** UCR solamente
...
**Solución:** Python package + CLI + Git

```bash
pip install bucr-rotulador
rotulador init  # Setup inicial
rotulador generate-all
git add output/
git commit -m "Generated signs for semester 2025-1"
```

**Inversión:** ~40h desarrollo  
**Mantenimiento:** ~2h/semestre  
**ROI:** Alto (vs diseño manual)
